...
version: 1.10           # string "1.10", not 1.1
port: 08080             # string "08080", not octal
```

Quoted strings are automatically unwrapped:
...
These YAML features are intentionally excluded:
...
- Tabs for indentation only (not content)
