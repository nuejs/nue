...
export class Model {
    ...
    all(params) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.model_all(this.__wbg_ptr, params);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    filter(filters, params) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.model_filter(this.__wbg_ptr, filters, params);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    search(query, params) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.model_search(this.__wbg_ptr, ptr0, len0, params);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    get(id) {
        const ret = wasm.model_get(this.__wbg_ptr, id);
        let v1;
        if (ret[0] !== 0) {
