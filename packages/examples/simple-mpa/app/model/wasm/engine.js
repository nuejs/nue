...
export class Engine {
    ...
    add_events(input) {
        ...
        wasm.engine_add_events(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {number}
     */
    get_total() {
        const ret = wasm.engine_get_total(this.__wbg_ptr);
        return ret >>> 0;
    }
    clear() {
    ...
    all(params) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.engine_all(this.__wbg_ptr, params);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    filter(filters, params) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.engine_filter(this.__wbg_ptr, filters, params);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    search(query, params) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.engine_search(this.__wbg_ptr, ptr0, len0, params);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
