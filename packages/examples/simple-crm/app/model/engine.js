...
export class Model {
     ...
     * @returns {string}
     */
    filter(filters, start, length) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(filters, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.model_filter(this.__wbg_ptr, ptr0, len0, start, length);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    search(query, start, length) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.model_search(this.__wbg_ptr, ptr0, len0, start, length);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
