...
export const BOOLEAN = 'disabled checked selected hidden readonly required autofocus autoplay async controls defer popover loop multiple muted nowrap open reversed scoped seamless sorted translate visibility pointer-events draggable contenteditable'.split(' ')
