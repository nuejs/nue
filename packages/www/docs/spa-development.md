...
> **Local development only**: SPA's currently work only as a local mockup to get a glimpse of what's coming. Production deployments with CloudFlare integration and universal data model come later. See [roadmap](roadmap) for details.
