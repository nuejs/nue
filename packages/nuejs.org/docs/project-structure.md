...
### 404 file
A file named `404.md` on the root level acts as a target for non-existent files. You can use the `include` statement to customize its styling and behaviour.
